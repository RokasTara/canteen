...
from canteen import app, bcrypt, db, mail
from canteen.forms import (RegistrationForm, LogInForm, UpdateAccountForm, PostForm,
OrderFormForm, RequestResetForm, ResetPasswordForm)
from canteen.models import Post, User
